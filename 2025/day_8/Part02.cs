...
while (distances.Count > 0) {
    ...
    if (circuits.Count == 1 && circuits[0].JunctionBoxes.Count == junctionBoxes.Count) {
        break;
    }
}

var (boxAIndex, boxBIndex) = lastConnection!.Value;

var result = junctionBoxes[boxAIndex].X * junctionBoxes[boxBIndex].X;
